...
public class DefaultOutputFormatGenerators {
     ...
     * string but not both.
     */
    protected static PaginationParameters generatePaginationParameters(String perPage, String page)
     ...
     * {@code never}
     */
    protected static long generateAsyncAfter(String asyncAfterString) throws BadApiRequestException {
        try {
     ...
     */
    public static ResponseFormatType generateAcceptFormat(String format) throws BadApiRequestException {
        try {
            return format == null ?

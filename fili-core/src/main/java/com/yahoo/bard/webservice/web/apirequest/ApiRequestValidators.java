...
public class ApiRequestValidators {
     ...
     */
    protected static void validateRequestDimensions(Set<Dimension> requestDimensions, LogicalTable table)
     ...
     */
    public static void validateAggregatability(Set<Dimension> apiDimensions, Map<Dimension, Set<ApiFilter>> apiFilters)
            throws BadApiRequestException {

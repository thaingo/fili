...
public class DefaultGranularityGenerators {
     ...
     */
    protected static Granularity generateGranularity(
     ...
     * @throws BadApiRequestException if the string matches no meaningful granularity
     */
    protected static Granularity generateGranularity(String granularity, GranularityParser granularityParser)
            throws BadApiRequestException {
        try {
